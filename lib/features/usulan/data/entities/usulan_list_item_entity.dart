...
part 'usulan_list_item_entity.freezed.dart';
part 'usulan_list_item_entity.g.dart';

@freezed
class ListUsulanItemEntiy with _$ListUsulanItemEntiy {
  const factory ListUsulanItemEntiy({
    @Default('U.820.2024.09123') @JsonKey(name: 'id_usulan') String idUsulan,
    ...
    @Default('') @JsonKey(name: 'status_tempat_tinggal') String statusTempatTinggal,
    ...
    @Default('') @JsonKey(name: 'desc_kategori_produk') String descKategoriProduk,
    @Default('') @JsonKey(name: 'desc_produk') String descProduk,
    @Default('') @JsonKey(name: 'desc_template_dokumen') String descJenisPengajuan,
    ...
    @Default('') @JsonKey(name: 'desc_status_pernikahan') String descStatusPernikahan,
  }) = _ListUsulanItemEntiy;
  const ListUsulanItemEntiy._();

  factory ListUsulanItemEntiy.fromJson(Map<String, dynamic> json) => _$ListUsulanItemEntiyFromJson(json);
}
