...
mixin _$PaginationState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T items) onGoingLoading,
    required TResult Function(T items, Object? e, StackTrace? stk) onGoingError,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(T items)? onGoingLoading,
    TResult? Function(T items, Object? e, StackTrace? stk)? onGoingError,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _Data<T> implements PaginationState<T> {
  const factory _Data(final T items) = _$DataImpl<T>;
...
class _$OnGoingLoadingImpl<T> implements _OnGoingLoading<T> {
  const _$OnGoingLoadingImpl(this.items);
...
abstract class _OnGoingLoading<T> implements PaginationState<T> {
  const factory _OnGoingLoading(final T items) = _$OnGoingLoadingImpl<T>;
...
abstract class _$$OnGoingErrorImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({T items, Object? e, StackTrace? stk});
}
...
class _$OnGoingErrorImpl<T> implements _OnGoingError<T> {
  const _$OnGoingErrorImpl(this.items, this.e, [this.stk]);
...
abstract class _OnGoingError<T> implements PaginationState<T> {
  const factory _OnGoingError(final T items, final Object? e,
