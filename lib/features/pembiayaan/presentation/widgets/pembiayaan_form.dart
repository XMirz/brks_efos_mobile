...
class PembiayaanForm extends ConsumerWidget {
  const PembiayaanForm({super.key});
          ...
          return Column(
            ...
            children: [
              ...
              OurDropDownField(
                ...
                value: formState.idKategoriProduk.showValue,
                  ...
                  .when(
                    data: (data) {
                      return OurDropDownField(
                        ...
                        value: formState.idProduk.showValue,
                  ...
                  .when(
                    data: (data) {
                      return OurDropDownField(
                        ...
                        value: formState.idJenisPengajuan.showValue,
                        onChanged: (value, label) => ref
                            .read(pembiayaanFormProvider.notifier)
                  ...
                  .when(
                    data: (data) {
                      return OurDropDownField(
                        ...
                        value: formState.idSubProduk.showValue,
                        onChanged: (value, label) => ref
                            .read(pembiayaanFormProvider.notifier)
                  ...
                  .when(
                    data: (data) {
                      return OurDropDownField(
                        ...
                        value: formState.idPlan.showValue,
                        onChanged: (value, label) => ref
                            .read(pembiayaanFormProvider.notifier)
                            .setPlan(value, label),
                      );
