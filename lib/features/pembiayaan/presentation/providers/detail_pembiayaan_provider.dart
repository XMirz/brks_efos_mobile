...
final detailKonsumtifProvider = StateNotifierProvider.family.autoDispose<
    DetailPembiayaanNotifier<PembiayaanDetailEntity>,
    AsyncValue<PembiayaanDetailEntity>,
    String>(
  (ref, idLoan) {
    ...
    return DetailPembiayaanNotifier<PembiayaanDetailEntity>(
      fetcher: (request) {
        return ref
            ...
            .fetchDetail(ApiPath.detailPembiayaanKonsumtif, request);
      },
      idLoan: idLoan,
...
final detailProduktifProvider = StateNotifierProvider.family.autoDispose<
    DetailPembiayaanNotifier<PembiayaanDetailEntity>,
    AsyncValue<PembiayaanDetailEntity>,
    String>(
  (ref, idLoan) {
    ...
    return DetailPembiayaanNotifier<PembiayaanDetailEntity>(
      fetcher: (request) {
        return ref
            .read(pembiayaanRepositoryProvider)
            .fetchDetail(ApiPath.detailPembiayaanProduktif, request);
      },
      idLoan: idLoan,
      idCabang: user.idCabang,
      username: user.username,
