...
// @JsonKey(name: 'angsuran_pengajuan') required String angsuranPengajuan,
  ...
  @override
  String toString() {
    return 'ProdukPembiayaanEntity(idKategoriProduk: $idKategoriProduk, idProduk: $idProduk, idJenisPengajuan: $idJenisPengajuan, idSubProduk: $idSubProduk, idPlan: $idPlan, tujuanPembiayaan: $tujuanPembiayaan, plafonPengajuan: $plafonPengajuan, tenorPengajuan: $tenorPengajuan, id: $id)';
  }
...
abstract class _ProdukPembiayaanEntity extends ProdukPembiayaanEntity {
  const factory _ProdukPembiayaanEntity(
      {@JsonKey(name: 'id_kategori_produk')
      required final dynamic idKategoriProduk,
      @JsonKey(name: 'id_produk') required final dynamic idProduk,
      @JsonKey(name: 'id_template_dokumen')
