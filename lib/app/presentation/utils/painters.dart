...
class BezierPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (drawStart) {
      angle = 3 * pi / 4;
      offset1 = _offset(radius, double.parse(angle.toString()));
      offset2 = _offset(radius, double.parse((-angle).toString()));
      path = Path()
        ..moveTo(offset1.dx, offset1.dy)
        ..quadraticBezierTo(0, size.height / 2, -radius, radius) // TODO connector start & gradient
